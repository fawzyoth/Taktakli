    ...
    <div class="p-4 sm:p-6 lg:p-8">
      ...
      <div class="bg-white dark:text-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
        <div class="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-800">
          <div class="flex flex-col lg:flex-row gap-4">
            <div class="flex-1 relative">
              ...
              <input
                ...
                class="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white placeholder-gray-600 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          ...
          <div class="mt-4 flex items-center justify-between text-sm text-gray-700 dark:text-gray-400">
            <div>
