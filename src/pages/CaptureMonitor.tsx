          ...
          <div className="space-y-4">
            {filteredPhoneNumbers.map((phoneData) => {
              ...
              return (
                <div
                  key={phoneData.id}
                  className="bg-gradient-to-br from-white to-blue-50/30 dark:from-gray-900 dark:to-blue-950/20 rounded-2xl border-2 border-blue-100 dark:border-blue-900/40 hover:border-blue-200 dark:hover:border-blue-800/60 hover:shadow-xl shadow-blue-100/50 dark:shadow-blue-900/20 transition-all duration-300 overflow-hidden relative"
                >
                  <div className="absolute top-5 right-5 z-10">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 text-white w-12 h-12 rounded-xl flex items-center justify-center shadow-lg font-bold text-xl ring-4 ring-blue-100 dark:ring-blue-900/30">
                  ...
                  <div className="p-6">
                    <div className="flex flex-col gap-4">
                      <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                        <div className="flex items-start space-x-3 flex-1 min-w-0">
                          <div className="flex-shrink-0">
                            <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-md">
                        ...
                        <div className="flex-shrink-0 sm:mt-1">
                          <div className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 px-5 py-3 rounded-xl inline-flex shadow-lg">
                      ...
                      <div className="border-t-2 border-blue-100 dark:border-blue-900/40 pt-4">
                        <label className="block text-xs font-semibold text-blue-700 dark:text-blue-400 mb-3 uppercase tracking-wide">
                          Contact Status
                        </label>
                    ...
                    {hasComments && (
                      <div className="mt-4 space-y-2 border-t-2 border-blue-100 dark:border-blue-900/40 pt-4">
                        ...
                        {displayComments?.map((comment) => (
                          <div
                            key={comment.id}
                            className="bg-blue-50/50 dark:bg-blue-950/20 rounded-lg p-3 border border-blue-100 dark:border-blue-900/40"
                          >
                            <p className="text-gray-900 dark:text-gray-100 text-sm leading-relaxed font-medium">{comment.comment_text}</p>
                          </div>
                        ))}
                        ...
                        {phoneData.comments.length > 2 && (
                          <button
                            ...
                            className="w-full flex items-center justify-center space-x-2 text-blue-700 dark:text-blue-300 hover:text-blue-900 dark:hover:text-blue-100 bg-blue-50 dark:bg-blue-950/30 hover:bg-blue-100 dark:hover:bg-blue-900/40 px-4 py-2.5 rounded-lg text-sm font-semibold transition border-2 border-blue-200 dark:border-blue-800/50"
                          >
                            <MessageCircle className="w-4 h-4" />
                            <span>View All {phoneData.comments.length} Comments</span>
                          </button>
                        )}
                      </div>
                    )}
