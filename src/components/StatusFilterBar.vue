<template>
  <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
            <FilterIcon class="w-5 h-5 text-blue-600 dark:text-blue-400" />
            Filter by Status
          </h3>
          <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Click to filter, or select multiple statuses</p>
        </div>
